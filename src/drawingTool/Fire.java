...
public class Fire {
	...
	public void draw() {
		...
		Drawing.pen().drawLine(locationX + 30, locationY + height + 20, locationX + 30, locationY + height + 40);
		Drawing.pen().drawLine(locationX + 45, locationY + height + 20, locationX + 30, locationY + height + 40);
